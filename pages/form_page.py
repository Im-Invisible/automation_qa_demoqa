...
class FormPage(BasePage):
    ...
    def fill_form_fields(self):
        ...
        self.element_is_visible(self.locators.USER_MOBILE).send_keys(person.mobile)
        self.element_is_visible(self.locators.SUBJECT).send_keys('Physics')
        self.element_is_visible(self.locators.SUBJECT).send_keys(Keys.RETURN)
        self.element_is_visible(self.locators.HOBBIES).click()
        self.element_is_present(self.locators.PICTURE_INPUT).send_keys(path)
        os.remove(path)
